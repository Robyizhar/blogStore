...
class ProvinsieTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        //ngangge query builder unruk menjalankan query yang sudah ada
        DB::insert("INSERT INTO `provinsies` (`id`, `nama`, `created_at`, `updated_at`) VALUES
